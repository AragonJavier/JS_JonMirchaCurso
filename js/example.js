...
const palindromo = (word = "") => {
  ...
  return word === reverse
    ? console.info(
        `Sí es palíndromo, Palabra original ${word}, Palabra al revés ${reverse}`
      )
    : console.info(
        `No es palíndromo, Palabra original ${word}, Palabra al revés ${reverse}`
      );
}; */
//palindromo("Hola")
...
/* const capicua = (numero = 0) => {
  ...
  return numero === reverse
    ? console.info(
        `Sí es capícua, Número original ${numero}, Número al revés ${reverse}`
      )
    : console.info(
        `No es capícua, Número original ${numero}, Número al revés ${reverse}`
      );
};
capicua(2000); */
/*
